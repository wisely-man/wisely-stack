package com.wisely.starter.core.thread.plugins;

import com.wisely.starter.core.exception.eum.CommonExceptionEnum;
import com.wisely.starter.core.exception.handler.ExceptionBuilder;
import com.wisely.starter.core.exception.handler.ExceptionManager;
...
public class AsyncPlugin implements AsyncConfigurer {
    ...
    public Executor getAsyncExecutor() {
        ...
        ExceptionManager.buildException(CommonExceptionEnum.CONFIG_ERROR, "plugins.async.mode");
        return null;
    }
